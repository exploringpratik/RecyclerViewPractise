...
import com.example.pratik.ghuamunepal.home.RecyclerVerticalActivity;
...
public class RecyclerViewDataAdapter extends RecyclerView.Adapter<RecyclerViewDataAdapter.ItemRowHolder>{
    ...
    public ItemRowHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_places, null);
    ...
    public void onBindViewHolder(ItemRowHolder holder, int position) {
        ...
        holder.btnMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext,RecyclerVerticalActivity.class);
